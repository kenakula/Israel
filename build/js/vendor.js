 ...
 */
  ...
  var callbackPhone = document.querySelector('#phoneCallback');

  var mask = IMask(callbackPhone, {
    mask: PHONE_NUMBER_MASK,
    lazy: true,
  });

  var contactsPhone = document.querySelector('#contactsPhone');

  var mask = IMask(contactsPhone, {
    mask: PHONE_NUMBER_MASK,
    lazy: false,
  });

  var modalPhone = document.querySelector('#modalPhone');

  var mask = IMask(modalPhone, {
    mask: PHONE_NUMBER_MASK,
    lazy: true,
  });
  ...
  var israelSlider = document.querySelector('#israelSlider');

  var resizeTimer;

  var israelSwiper = new Swiper(israelSlider, {
    speed: 400,
    loop: true,
    spaceBetween: 50,
    pagination: {
  ...
  if (window.matchMedia('(min-width: 768px)').matches) {
    israelSwiper.destroy(false, true);
  }
  ...
  $(window).on('resize', function () {
    ...
    resizeTimer = setTimeout(function () {
      ...
      if (window.matchMedia('(min-width: 768px)').matches && israelSwiper) {
        israelSwiper.destroy(false, true);
      } else {
        israelSwiper = new Swiper(israelSlider, {
          speed: 400,
          loop: true,
          spaceBetween: 50,
          pagination: {
